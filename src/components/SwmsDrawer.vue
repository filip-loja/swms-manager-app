...
<!--				/>-->
			...
			<div>
				...
				<div class="row q-gutter-md justify-center">
					<div class="col-4"><q-btn @click="onSave" flat color="positive" style="width: 100%">{{ submitBtnTitle }}</q-btn></div>
					<div class="col-4"><q-btn @click="onCancel" flat color="negative" style="width: 100%">Cancel</q-btn></div>
				</div>
			</div>
